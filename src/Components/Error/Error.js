...
const Error = () => {
    return (
      <main class="h-screen w-full flex flex-col justify-center items-center bg-gray-600">
        <h1 class="text-9xl font-extrabold text-white tracking-widest">404</h1>
        <div class="bg-black text-white px-2 text-sm rounded rotate-12 absolute">
          Page Not Found
        </div>
        <button class="mt-5">
          <Link to='/' class="relative inline-block text-sm font-medium text-white group active:text-white focus:outline-none focus:ring">
